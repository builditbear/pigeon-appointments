...
/**
 * Manages user interaction with the Update Customer screen.
 */
public class UpdateCustomerController implements Initializable {
    ...
    /**
     * A custom ComboBox cell which allows a FirstLevelDivision to be displayed by its name instead of the default
    ...
    /**
     * Filters the First Level Divisions available for selection such that only ones in the selected country can be chosen.
     * @param e The event generated by the user changing the selected country.
     */
    @FXML
    ...
    /**
     * Retrieves the updated information from the screen's form fields, updates the appropriate customer record in the
     * database, and then returns the user to the customer screen.
     * @param e
     */
    @FXML
     ...
     * @param e The event generated when the user clicks the cancel button.
     */
    @FXML
